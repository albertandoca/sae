...
(1,1,'Las matemáticas discretas son un área de las matemáticas encargadas del estudio de los conjuntos discretos: finitos o infinitos numerables.', 'Al terminar el curso el alumno conocerá', 'las técnicas y métodos del área de matemáticas discretas', ' más
importantes,', ' y será capaz de aplicarlos en la solución de problemas específicos. ', 'MD001', 1);
 
Select * from Silabo;
insert into Silabo (idPeriodoLectivo, idAsignatura, descripcion, objetivo1, objetivo2, objetivo3, objetivo4, codigo, estado) values 
(1,2,'Una metodología nos ordena, nos contiene, nos permite definir límites. Construir software complejo requiere un gran esfuerzo: tecnología, dinero y sobre todo: 
personas. Personas que interactúan entre sí, con diferentes grados de conocimiento, con diferentes roles, con diferentes intereses. ', 'Preparar', 'a los estudiantes para el desarrollo de software', 'mediante temas poco complicados', 
'para  adquisición por parte del estudiante de una formación avanzada, de carácter especializado y multidisciplinar, orientada a la especialización académica o profesional', 'DS001',1);
insert into Silabo (idPeriodoLectivo, idAsignatura, descripcion, objetivo1, objetivo2, objetivo3, objetivo4, codigo, estado) values 
(2,3, 'Fundamentos de Programación es una asignatura básica que permite crear programas que exhiban un comportamiento deseado. 
...
'y asi  adquieran el conocimiento teórico y práctico sobre las técnicas básicas de programación estructurada','M001', 1);
select * from Silabo;
...
(1, 2, 'los conjuntos', 'de una manera correcta','para aplicar en la programacion', 1.1);
insert into SilaboElementos(idSilaboUnidades, IdVerboBloom, objeto ,condicion, finalidad, codigo) values
(7, 3, 'la programacion orientada a objetos', 'basada en varias técnicas, incluyendo herencia, cohesión, abstracción, polimorfismo, acoplamiento y encapsulamiento.','con la finalidad de obtener buenos pprogramadores ', 1.1);
...
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (37,1);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (40,32);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (43,37);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (49,43);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (39,35);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (46,39);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (52,46);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (55,51);
insert into AsignaturaPrerrequisito (idAsignatura, idAsignaturaPrerequisito) values (9,51);
